...
{
    public static class SequentiallyImportReduceMemoryUsageService_BulkSave
    {
        public static void ImportSequentially_ReduceMemoryUsage_BulkSave(this string inputFileFullPath, TestDBContext context)
        {
            int count = 0;
