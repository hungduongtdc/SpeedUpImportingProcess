...
namespace SpeedUpImportingProcess.Extensions.CSVEx.EnumerableEX
{
    public static class EnumerableExtensions
    {
        ...
        public static async Task<ConcurrentBag<TResult>> TransformAsync<TSource, TTransformResult, TResult>(this IEnumerable<TSource> source, Func<TSource, Task<TTransformResult>> transformer, int maxDegreeOfParallelism,
        ...
        {
            var transformBlock = new ActionBlock<TSource>(action, new ExecutionDataflowBlockOptions()
            {
                MaxDegreeOfParallelism = maxDegreeOfParallelism
            });
