...
using SpeedUpImportingProcess.Extensions.CSVEx.EnumerableEX;
using System;
...
namespace SpeedUpImportingProcess.Extensions.CSVEx
{
    public static class CSVExtensions
    {
        ...
        public static IEnumerable<string> ReadHeaders(this FileDataDto fileImport, CancellationToken cancellationToken)
        {
            var csvConfig = new CsvConfiguration(CultureInfo.InvariantCulture)
            {
                ...
                {
                    var x = context.Parser.RawRecord;
                }
            };
